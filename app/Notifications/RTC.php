...
class RTC extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        ->greeting('Hello,')
        ->line('The application '.$this->ref_number.'has been a returned to compliance .')
    ...
    {
            return [
                'data' => 'The Application'.  $this->ref_number. 'has been returned to compliance',
        ];
    }
}

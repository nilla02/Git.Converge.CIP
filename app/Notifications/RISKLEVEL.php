...
class RISKLEVEL extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        ->greeting('Hello,')
        ->line('The application '.$this->ref_number.'has been a risk level of Medium Risk .')
    ...
    {
            return [
                'data' => 'The risk level for'. $this->ref_number.'has been set to Medium Risk',
        ];
    }
}

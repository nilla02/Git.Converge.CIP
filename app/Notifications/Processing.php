...
class Processing extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        ->greeting('Hello,')
        ->line('The application '.$this->ref_number.'has been is now being review by the Citizenship by investment saint lucia .')
    ...
    {
            return [
                'data' => 'Processing has begun for the application:'. $this->ref_number.'',
        ];
    }
}

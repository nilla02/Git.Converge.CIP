...
class phase2 extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        ->greeting('Hello,')
        ->line('The application '.$this->ref_number,"has been cleared by the assigned Verification Officer..")
    ...
    {
            return [
                'data' => 'Application ready for Due Diligence ' . $this->full_name,
        ];
    }
}
